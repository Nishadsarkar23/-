...
OWNER_USERNAME = getenv("OWNER_USERNAME", "@Kartik_ni")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME", "@Kajal_N_bot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "NISHAD MUSIC")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/LOCO-PILOT/NISADMUSIC",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://iili.io/JUmmnHl.md.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://iili.io/JUpry37.md.jpg"
)
